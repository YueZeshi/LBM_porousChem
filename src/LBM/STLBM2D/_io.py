...
@ti.data_oriented
class STLBM2D_INPUT(STLBM2D_BASE):
    #----------
    # 用户使用函数
    #----------
    # 初始化场
    ...
    def set_viscosity(self,niu,unit = "lattice"):#定义常黏度
        ...
        def new_viscosity(self,i):
            return niu
        self.viscosity = new_viscosity.__get__(self,STLBM2D_INPUT)
    def set_viscosity_func(self,func):# 根据方程定义黏度
        self.viscosity = func.__get__(self,STLBM2D_INPUT)
    ## 多孔介质
...
# 输出 可视化
@ti.data_oriented
class STLBM2D_OUTPUT(STLBM2D_BASE):
